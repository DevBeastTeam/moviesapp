...
import 'double_circular_progress_indicator.dart';
...
class FullScreenDoubleCircularProgressIndicator extends StatefulWidget {
  ...
  @override
  _FullScreenDoubleCircularProgressIndicatorState createState() =>
      _FullScreenDoubleCircularProgressIndicatorState();
}
              ...
              child: Container(
                ...
                child: Container(
                  ...
                  child: Container(
                    width: 170,
                    padding: const EdgeInsets.all(30),
                    child: DoubleCircularProgressIndicator(text: widget.text),
                  ),
                ),
              ),
            ),
