...
class PronlevelsPage1 extends ConsumerStatefulWidget {
  const PronlevelsPage1({super.key});

  @override
  ConsumerState<PronlevelsPage1> createState() => _PronlevelsPage1State();
}

class _PronlevelsPage1State extends ConsumerState<PronlevelsPage1> {
  @override
  void initState() {
    super.initState();
    syncFirstF();
  ...
  void syncFirstF() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ref
          ...
          .getPronounciationF(context, loadingFor: "plevel");
      // ref
      //         .read(pronounciationVm)
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            if (p.loadingFor == "plevel") QuickTikTokLoader(),
                    ...
                    child: SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          var data = p.pLevelCatgModelData!.data.levels[index]
                              .toUpperCase();
                          return Padding(
