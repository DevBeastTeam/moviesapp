...
class PronCatgLessonsPage3 extends StatefulWidget {
  ...
  @override
  State<PronCatgLessonsPage3> createState() => _PronCatgLessonsPage3State();
}
                ...
                Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: ListView.builder(
                      itemCount:
                          controller.pLevelCatgModelData!.data.lessons.length,
                      shrinkWrap: true,
                      controller: ScrollController(),
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        var data =
                            controller.pLevelCatgModelData!.data.lessons[index];
                        return Padding(
                          padding: const EdgeInsets.symmetric(
                            horizontal: 10,
                            vertical: 7,
