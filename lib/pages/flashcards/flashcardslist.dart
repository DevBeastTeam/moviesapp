...
class FlashCardsListsPageState extends ConsumerState<FlashCardsListPage> {
  ...
  final isTablet = mediaQuery.size.shortestSide >= 600; // Common tablet threshold
                                    ...
                                    child: Center(
                                      child: Text(
                                        ...
                                        style: t.labelSmall!.copyWith(
                                          color:
                                              flashSubject.id == p.selectedSubject
                                              ? Colors.blue
                                              : Colors.white,
                                        ),
                                      ),
                      ...
                      child: Wrap(
                        ...
                        children: p.flashCardsList.first.movies.map((item) {
                          ...
                          if (isTablet) {
                            ...
                            itemWidth = isLandscape ? mediaQuery.size.width * 0.45 : mediaQuery.size.width;
                          }
                          ...
                          return SizedBox(
                            ...
                            child: FlashCardsTileWidget(
                              item: item,
                              onTap: () {
                                context.go("/home/fc/fcdetails", extra: {
                                  'movie': item,
